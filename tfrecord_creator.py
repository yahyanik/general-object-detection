...
#
#     ap.add_argument("-ckpt", "--checkpoint_dir", type=str,
#                     default='saved_chckpoints/flowers',
#                     help="where is the model located")
#
...
# if __name__ == '__main__':
#     args = args_method()
#     model_main(checkpoint_dir=args['checkpoint_dir'], pipeline_config_path=args['model_config'])
